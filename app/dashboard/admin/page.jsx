...
import DashboardListings from "../agent/_components/Dashboard";
import OnboardingForm from "../agent/_components/OnboardingForm";
import AddNewListing from '../agent/_components/AddNewListing';
import RoomateListing from "./_components/RoomateListing";
...
export default function AgentDashboard() {
  ...
  const navItems = [
    ...
    { name: "Add Roomate Listing", icon: <PlusCircle size={20} /> },
    { name: "Manage Users", icon: <UserCog size={20} /> },
  ...
  return (
    <div className="flex min-h-screen bg-[#FDFDFD]">
      {/* --- DESKTOP SIDEBAR --- */}
      <aside className="hidden lg:flex w-64 bg-slate-100 border-r border-slate-200 fixed h-full flex-col p-2 transition-all">
        <div className="mb-10">
          <Link href={"/"}>
            <Image
              src={"/logo.svg"}
      ...
      <main className="flex-1 lg:ml-64 pb-24 lg:pb-0">
        ...
        <div className="p-2 lg:p-5 max-w-6xl mx-auto">
          ...
          {activeTab === "Manage Users" && (
           ...
           {activeTab === "Add Roomate Listing" && (
            <div className="w-full bg-white p-3  rounded-[2rem] border border-slate-100">
              <RoomateListing />
            </div>
          )}
        </div>
