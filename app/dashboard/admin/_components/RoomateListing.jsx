...
import RoommateMediaUpload from "./RoommateMediaUpload";
...
export default function AddRoommate() {
  ...
  return (
    <div className="min-h-screen bg-slate-50 py-3">
      <div className="mx-auto max-w-2xl">
       
        <Card className="border-none  overflow-hidden bg-white">
          <CardHeader className="bg-slate-950 text-white p-4 md:p-6">
            <CardTitle className="text-xl md:text-2xl font-black tracking-tighter">
          ...
          <CardContent className="p-3 md:p-6 space-y-5">
            ...
            <div className="bg-slate-50 p-3 md:p-4 rounded-[2rem] border border-slate-100">
              <RoommateMediaUpload
            ...
            <form onSubmit={onSubmit} className="space-y-8">
              ...
              <Button
                type="submit"
                disabled={loading}
                className="w-[90%] bg-blue-600 hover:bg-slate-950 text-white h-14 md:h-20 rounded-[2rem] text-lg font-black shadow-2xl shadow-blue-200 transition-all flex gap-3 mt-4"
              >
