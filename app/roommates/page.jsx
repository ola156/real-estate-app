...
import { User, MapPin, MessageCircle, Loader2, Plus, Sparkles, Trash2 } from "lucide-react";
...
export default function RoommatePage() {
  ...
  const handleListRoom = () => {
    const phone = "+2348087442174";
    const msg = encodeURIComponent("Hi! I am looking for a roommate to pair with. Can you help me list it?");
                ...
                >
                  ...
                  <div className="flex justify-between items-start mb-8">
                    ...
                    <div className="flex flex-col items-end gap-2">
                      ...
                      {/* NEW: Gender Badge */}
                      <Badge className="bg-slate-900 text-white border-none px-4 py-1.5 rounded-full font-bold text-[10px] uppercase tracking-wider">
